...
metadata {
    definition (name: "Zigbee Metering Plug - AlwaysOn", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "oic.d.smartplug", mnmn: "SmartThings",  vid: "generic-switch-power-energy") {
